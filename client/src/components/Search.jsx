    ...
    <div>
      <div className={styles.searchfile}>
        <div className={styles.searchfield}>
          ...
          <DebounceInput placeholder='Autorenname' name='author' debounceTimeout={500} onChange={(e) => changeData(e)} value={searchdata['author']} />
          <button type='button' onClick={fetchSearch}>Suche</button>
        </div>
      </div>
